...
import {
    Slider
} from "https://framerusercontent.com/modules/AHY1z1xp5QsxaZBkEL9H/7Qvf2RhlgA8L1UHMchaV/Slider.js";
 ...
 */
export const Audio = withCSS(function Audio(props) {
    var _props_style;
    const {
        playing,
        background,
    ...
    } else if (props === null || props === void 0 ? void 0 : (_props_style = props.style) === null || _props_style === void 0 ? void 0 : _props_style.cursor) {
    ...
    const handlePlayStateUpdate = useCallback(_ => {
        ...
        (_playerInfo_current = playerInfo.current) === null || _playerInfo_current === void 0 ? void 0 : (_playerInfo_current_animation = _playerInfo_current.animation) === null || _playerInfo_current_animation === void 0 ? void 0 : _playerInfo_current_animation.stop();
    ...
    const initProgress = () => {
        if (!isMotionValue(progress)) {
            player.current.currentTime = progress * .01 * player.current.duration;
        }
    };
    const handleReady = () => { // This tries to run on every pause
    ...
    useEffect(() => {
        if (shouldPlay) { // In preview when prop changes, pause/play
            if (playing === true) playAudio();
            else pauseAudio();
        } else { // Only set the state for canvas use
    ...
    useEffect(() => {
        ...
        if ((_player_current = player.current) === null || _player_current === void 0 ? void 0 : _player_current.duration) setDuration(player.current.duration);
    ...
    useMotionValueEvent(trackProgress, "change", val => {
        var _player_current;
        const progressPercent = ((_player_current = player.current) === null || _player_current === void 0 ? void 0 : _player_current.duration) ? val / player.current.duration * 100 : null;
        if (onTimeUpdate) {
...
}, [".framer-audio-icon { outline: none; }", ".framer-audio-icons:focus-visible { outline: auto; }"]);
Audio.defaultProps = {
    background: "#EBEBEB",
    trackColor: "#FFFFFF",
    font: {
...
function PlayIcon(props) {
    return /*#__PURE__*/ _jsx(motion.svg, { ...props,
...
function PauseIcon(props) {
    return /*#__PURE__*/ _jsxs(motion.svg, { ...props,
        className: "framer-audio-icon",
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 16 16",
        children: [ /*#__PURE__*/ _jsx("path", {
